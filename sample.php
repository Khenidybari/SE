...
<div class="container">
  <div class="row">
    <div class="col-md-12">
    <a class = "btn btn-primary" href="addsample.php" role="button">Add new</a>
...
// table para sa elem ano ipakita
select a.id,a.first_name,a.last_name, e.schoolname AS elementary_school,e.dategraduated AS elementary_date FROM alumin a LEFT JOIN elementary e ON a.elementary_id = e.elementary_id