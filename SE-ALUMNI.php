...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#contact">Map</a></li>
                            <li class="scroll-to-section"><a href="#About">About Us</a></li>
                            <li class="scroll-to-section">
                                <div class="main-blue-button"><a href="login.php">Admin</a></div>
                            </li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="section-heading wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <h6>GALLERY</h6>
                        <h2>Discover the latest <em>events</em> and <span>echos</span></h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="Goals" class="about-us section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-image wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assets/images/wmsu.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6 align-self-center wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                    <div class="section-heading">
                        ...
                        <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel lobortis arcu, at
                            dignissim ligula.
                            Nullam et velit at magna hendrerit gravida non ac dui. Pellentesque habitant morbi tristique
                            senectus et
                            netus et malesuada fames ac turpis egestas. Mauris hendrerit, lorem eu pretium pharetra,
                            augue ipsum
                            gravida diam, eget condimentum ex nunc mattis enim. Integer porta imperdiet semper.
                            Curabitur risus nunc,
                            malesuada a faucibus quis, facilisis vel est. Pellentesque iaculis interdum mauris, at
                            gravida ex
                                        ...
                                        <div class="contact-info">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="#">Normal Rd, baliwasan ZC</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
            ...
            <div id="About" class="our-portfolio section">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="section-heading wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
