...
// Query to fetch rows with the same name, middle, and last in any of the tables
$sql = "(SELECT name, middle, last FROM elementary WHERE dategraduated = $tenYearsAgo)
        UNION
        (SELECT name, middle, last FROM highschool WHERE dategraduated = $tenYearsAgo)
        UNION
        (SELECT name, middle, last FROM seniorhighschool WHERE dategraduated = $tenYearsAgo)
        UNION
        (SELECT name, middle, last FROM college WHERE dategraduated = $tenYearsAgo)";
