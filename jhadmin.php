...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
					...
					$sql = "select a.id, a.first_name,a.last_name, h.schoolname AS highschool_school,h.dategraduated AS highschool_date FROM alumin a LEFT JOIN highschool h ON a.highschool_id = h.highschool_id";
            ...
            echo "
                    ...
                    <td>  $row[id] </td>
                     <td>  $row[first_name]  </td>
                      <td>  $row[last_name]  </td>
                      <td>  $row[highschool_school]  </td>
                      <td>  $row[highschool_date]  </td>
                       <td><div>
