        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">ADD JUNIOR HIGH SCHOOL</h2>
                ...
                <?php
                 if(isset($_POST["submit"])){
                    ...
                    if (empty($name) OR empty($yeargraduated)) {
                      ...
                      $sql = "SELECT * FROM jhs WHERE name = '$name'";
                      ...
                      if(count($errors)>0){
                        ...
                        $sql = "INSERT INTO jhs (name, yeargraduated) Values ( ?, ? )";
              ...
              <form action="addjh.php" method="post">
