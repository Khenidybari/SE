      ...
      <section class="vh-100" style="background-image: url('assets/images/MAINN.png');background-position: center;">
        <div class="col-md-12">
          <div class="table-responsive">
            <table id="example" class="table table-striped table-boardered table-hover" style="justify-content: center; width:100%">
            <div class="btn-group">
              <thead>
                <tr>
                  <th>ID</th>
...
<div class="dropdown">
  <button class="btn btn-info dropdown-toggle">Dropdown</button>
